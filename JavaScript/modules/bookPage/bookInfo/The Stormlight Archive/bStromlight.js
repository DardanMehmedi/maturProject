...
const bookInfo = [
    {
        ...
        bookInfo: [
            ...
            {P:`The result of over ten years of planning, writing, and world-building, The Way of Kings is but the opening movement of the Stormlight Archive, a bold masterpiece in the making.`},
            {P:`Speak again the ancient oaths:`},
            {P:`Life before death.`},
            {P:`Strength before weakness.
            `},
            {P:`Journey before Destination.`},
            {P:`and return to men the Shards they once bore.
            `},
            {P:`The Knights Radiant must stand again.`},
            ]
    }
]
